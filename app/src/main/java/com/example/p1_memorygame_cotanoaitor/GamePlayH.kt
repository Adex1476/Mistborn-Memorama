...
class GamePlayH : AppCompatActivity(), View.OnClickListener {
    ...
    private lateinit var viewModel: GameViewModelH

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.game_play_h)

        viewModel = ViewModelProvider(this).get(GameViewModelH::class.java)
