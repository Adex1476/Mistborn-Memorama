...
class GamePlayA : AppCompatActivity(), View.OnClickListener {
    ...
    private lateinit var viewModel: GameViewModelA

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.game_play_a)

        viewModel = ViewModelProvider(this).get(GameViewModelA::class.java)
        ...
        carta7 = findViewById(R.id.revers7)
        carta8 = findViewById(R.id.revers8)
    ...
    override fun onClick(v: View?) {
        when (v) {
            ...
            carta7 -> if(!viewModel.getBlocked(6) && !viewModel.animation) girarCarta(6, carta7)
            carta8 -> if(!viewModel.getBlocked(7) && !viewModel.animation) girarCarta(7, carta8)
        }
        viewModel.movements++
